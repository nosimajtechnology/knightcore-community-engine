...
Use one clear setup, one readable action, and one consequence caused by that action or situation. The first frame should make the premise legible. Treat absurd events sincerely inside the world.

Vary emotional registers. Knightcore can be tender, romantic, reflective, embarrassed, tired, friendly, peaceful, or strange—not only aggressive. Gnomes, dragons, horses, mushrooms, castles, stars, swords, kings, and quests are optional vocabulary, never mandatory checkboxes.
